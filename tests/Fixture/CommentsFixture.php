...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'discussion_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-09-09 17:44:28',
                'modified' => '2020-09-09 17:44:28',
                'deleted' => '2020-09-09 17:44:28',
            ],
        ];
        parent::init();
    }
